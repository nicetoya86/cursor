...
**시스템 응답:** 해결되었어요, 해결되지 않았어요, 문제가 해결되었어요, 도움이 되었어요, 도움이 되지 않았어요, 더 궁금해요, 선택해 주세요, 확인해 주세요, 클릭해 주세요, 눌러 주세요

**자동 응답:** 안녕하세요, 여신티켓입니다, 문의 주셔서 감사합니다, 빠른 시일 내, 답변 드리겠습니다, 운영시간 안내, 평일, 주말 공휴일 휴무, 점심시간, 순차적으로 처리, 양해 부탁, 감사합니다, 고객님 안녕하세요, 문의 접수 완료, 담당자 확인 후 연락

**시나리오 기반 안내:** 아래 옵션, 선택해 주세요, 해당 사항 선택, 진행해 주세요, 더 자세한 안내, 추가 문의 사항, 다음 단계 진행, 확인 버튼, 아래 링크, 관련 문서 확인, FAQ 참고, 도움말 페이지, 고객센터 문의, 1:1 문의
...
**문서 관련:** [도움말], [FAQ], [가이드], [매뉴얼], [안내], [문서], 관련 문서:, 참고 문서:, 도움말 문서, 사용법 안내, 자주 묻는 질문, 문서 내용:, articles/, help., 운영시간, 순차적으로 안내

**URL/웹사이트:** http://, https://, www., .com, .co.kr

**개인정보:** 인증번호, 휴대전화, 연락처, 전화번호, 010-, 02-, 031-, 032-, 033-, 041-, 042-, 043-, 044-, 051-, 052-, 053-, 054-, 055-, 061-, 062-, 063-, 064-, 070-, 6자리 숫자 패턴
    ...
    try {
      const response = await openai.chat.completions.create({
        ...
        messages: [
          {
            role: "system",
            content: "당신은 고객 서비스 티켓 분석 전문가입니다. 제시된 5단계 우선순위 기준에 따라 고객 문의 내용을 정확히 추출해주세요. 상세한 제외 대상 패턴을 엄격히 적용하여 오직 고객의 실제 문의 내용만을 추출하세요."
          },
          {
            role: "user",
            content: prompt
